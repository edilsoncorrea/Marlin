...
#undef en
...
#endif
#ifndef MSG_HALTED
  #define MSG_HALTED                          _UxGT("HALTED")
#endif
  ...
  #define MSG_INFO_PRINTER_MENU               _UxGT("Info")
#endif
  ...
  #define MSG_CASE_LIGHT_BRIGHTNESS           _UxGT("Light BRIGHTNESS")
    ...
    #define MSG_INFO_PRINT_COUNT              _UxGT("Count")
  #endif
  ...
  #define MSG_FILAMENT_CHANGE_HEADER_PAUSE    _UxGT("PAUSED")
#endif
