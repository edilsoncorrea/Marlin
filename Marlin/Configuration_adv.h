...
#define USE_CONTROLLER_FAN
  ...
  #define CONTROLLER_FAN_PIN 10           // Set a custom pin for the controller fan
...
#define HOMING_BUMP_DIVISOR { 3, 3 }       // Re-Bump Speed Divisor (Divides the Homing Feedrate)
...
#define ENCODER_RATE_MULTIPLIER
  ...
  #define ENCODER_100X_STEPS_PER_SEC  40  // (steps/s) Encoder rate for 100x speed
#endif
...
//#define LCD_BACKLIGHT_TIMEOUT_MINS 1  // (minutes) Timeout before turning off the backlight
  ...
  //#define LCD_TIMEOUT_TO_STATUS 15000   // (ms)
    ...
    #define BOOTSCREEN_TIMEOUT 4500       // (ms) Total Duration to display the boot screen(s)
...
// LCD Print Progress options
    ...
    //#define LCD_PROGRESS_BAR            // Show a progress bar on HD44780 LCDs for SD printing
      ...
      #define PROGRESS_BAR_BAR_TIME 200  // (ms) Amount of time to show the bar
      #define PROGRESS_BAR_MSG_TIME 300  // (ms) Amount of time to show the status message
...
#define LASER_FEATURE
  ...
  //#define CUTTER_POWER_RELATIVE              // Set speed proportional to [SPEED_POWER_MIN...SPEED_POWER_MAX]
     ...
     */
      ...
      #define SPEED_POWER_MAX         20000    // (RPM) SuperPID router controller 0 - 30,000 RPM
      #define SPEED_POWER_STARTUP      3000    // (RPM) M3/M4 speed/power default (with no arguments)
    #endif
